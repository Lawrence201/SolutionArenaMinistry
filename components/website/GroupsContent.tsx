                            ...
                            <div key={index} className="col-lg-6 col-md-6 col-sm-12">
                                <div className={`${styles.ministry} text-center light-bg position-relative`}>
                                    <img
                                        ...
                                        alt={family.name}
                                    />
                                    <a href="#" onClick={(e) => e.preventDefault()} className="font-bold flex-all position-relative">
                                        {family.name}
                                    </a>
                                </div>
                            </div>
                ...
                <div className="container">
                    <ul className={styles.socialList}>
                        <li className={styles.socialItem}>
                            <a href="#" onClick={(e) => e.preventDefault()} className={`${styles.socialIcon} rounded-circle`}>
